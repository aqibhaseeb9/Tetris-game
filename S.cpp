...
S::S()
{
	Xcoordinates[0] = { 4 }, Xcoordinates[1] = { 5 }, Xcoordinates[2] = { 5 }, Xcoordinates[3] = { 6 },
		Ycoordinates[0] = { 1 }, Ycoordinates[1] = { 0 }, Ycoordinates[2] = { 1 }, Ycoordinates[3] = { 0 };
}
...
void S:: Draw(RenderWindow& window, float blockSize) 
{
