#include"J.h"
 ...
 J::J()
{
	Xcoordinates[0] = { 4 }, Xcoordinates[1] = { 5 }, Xcoordinates[2] = { 5 }, Xcoordinates[3] = { 5 },
		Ycoordinates[0] = { 2 }, Ycoordinates[1] = { 0 }, Ycoordinates[2] = { 1 }, Ycoordinates[3] = { 2 };
}




void J:: updateCoordinates() 
{

	switch (rotation) {
	case 0: // default (vertical J)
		Xcoordinates[0] = x;
		Ycoordinates[0] = y + 2;
...
void J:: rotate(int arr[20][10])
{
	...
	{
		if (x - 2 < 0)
			x = 0; // Push right to avoid overflow
		if (x + 2 >= 10)
...
void J:: Draw(RenderWindow& window, float blocks)
{
	RectangleShape block;
	block.setSize(Vector2f(blocks - 3.f, blocks - 3.f));
	block.setFillColor(Color(75, 0, 130));
