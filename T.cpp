 ...
 T::T()
{
	Xcoordinates[0] = { 4 }, Xcoordinates[1] = { 5 }, Xcoordinates[2] = { 5 }, Xcoordinates[3] = { 6 },
		Ycoordinates[0] = { 0 }, Ycoordinates[1] = { 0 }, Ycoordinates[2] = { 1 }, Ycoordinates[3] = { 0 };
}
...
void  T::rotate(int arr[20][10])
{
	...
	{
		if (x + 2 >= 10)
			x = 7;// Handling overflow on left size
	}
...
void T:: Draw(RenderWindow& window, float blocks)
{
